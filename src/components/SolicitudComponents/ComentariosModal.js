import {
  Modal, Dimensions, TouchableWithoutFeedback, StyleSheet, View, Text, TextInput, ScrollView,
} from 'react-native';
      ...
      >
        ...
        >
          ...
          >
            ...
            <TextInput onChangeText={this.onChangeText.bind(this)} maxLength={250} style={{ paddingHorizontal: '5%' }} multiline />
            <View style={{
              width: '95%', height: 1, backgroundColor: 'black', alignSelf: 'center',
            }}
            />
