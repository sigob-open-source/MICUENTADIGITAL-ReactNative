    ...
    <View style={{ flex: 1, height: '100%' }}>
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        <View style={styles.textInputContainer}>
          <TextInput style={styles.textInputStyle} placeholder="Dependencia/Oficina.*" placeholderTextColor="gray" />
        </View>

        <View style={styles.textInputContainer}>
          <TextInput style={styles.textInputStyle} placeholder="Busqueda de texto." placeholderTextColor="gray" />
        </View>
      </View>
